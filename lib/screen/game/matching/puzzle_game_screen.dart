...
class _PuzzleGameScreenState extends State<PuzzleGameScreen>
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text('Awesome!', style: TextStyle(fontFamily: 'Poppins',  fontSize: 32, fontWeight: FontWeight.bold, color: Colors.white)),
              Text('Level Two Completed!', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, color: Colors.white70)),
              SizedBox(height: 24),
              ElevatedButton.icon(
                onPressed: () {
                ...
                label: Text('Go to Level Three', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget build(BuildContext context) {
    ...
    final itemSize = (screenWidth / 10.0).clamp(32.0, 45.0);
      ...
      appBar: AppBar(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Puzzle', style: TextStyle(fontFamily: 'Poppins',  fontSize: isSmallScreen ? 16 : 20, fontWeight: FontWeight.w700, color: const Color(0xFF2D3436))),
                  Text('Match the items!', style: TextStyle(fontFamily: 'Poppins',  fontSize: isSmallScreen ? 10 : 12, color: const Color(0xFF636E72))),
                ],
              ),
            ),
          ],
        ...
        actions: [
          Container(
            ...
            child: Text('⭐ $score', style: TextStyle(fontFamily: 'Poppins', fontSize: isSmallScreen ? 14 : 16, fontWeight: FontWeight.bold, color: Colors.green)),
          ),
          SizedBox(width: 8),
        ],
      ),
              ...
              child: Column(
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Wrap(
                        ...
                        children: List.generate(themes.length, (index) {
                          ...
                          final themeWidth = (screenWidth / 5.2).clamp(65.0, 85.0);
                          return GestureDetector(
                            onTap: () => setState(() { selectedTheme = index; _initializeGame(); }),
                            child: Container(
                              width: themeWidth,
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: theme['color'], width: isSelected ? 3 : 2),
                                boxShadow: isSelected
                                    ? [BoxShadow(color: theme['color'].withOpacity(0.5), blurRadius: 10, offset: const Offset(0, 3))]
                                    : [],
                              ),
                              child: Column(
                                mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(theme['icon'], style: TextStyle(fontFamily: 'Poppins', fontSize: isVerySmallHeight ? 24 : (isSmallScreen ? 26 : 30))),
                                  SizedBox(height: 3),
                                  Text(
                                    theme['name'],
                                    style: TextStyle(fontFamily: 'Poppins', fontSize: 10, fontWeight: FontWeight.bold, color: isSelected ? Colors.white : Colors.black87),
                  ...
                  Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      Icon(Icons.arrow_downward, size: isSmallScreen ? 20 : 24, color: Colors.purple.shade300),
                      Text('Match Below', style: TextStyle(fontFamily: 'Poppins', fontSize: isSmallScreen ? 11 : 13, fontWeight: FontWeight.bold, color: Colors.purple.shade400)),
                    ],
                  ),
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: sourceItems.asMap().entries.map((entry) {
                        if (entry.value.isMatched) {
                          return Flexible(child: _buildEmptySlot(itemSize, isSmallScreen, isVerySmallHeight));
                        }
                        return Flexible(
                          child: Draggable<int>(
                            data: entry.key,
  ...
  Widget _buildTargetSlot(MatchItem item, bool isHovering, bool isWrong, double size, bool isSmall, bool isVerySmallHeight) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: item.isMatched ? Colors.green : isWrong ? Colors.red : isHovering ? Colors.blue : Colors.purple.shade300,
          width: 2.5,
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Column(
        ...
        mainAxisSize: MainAxisSize.min,
        children: [
          Flexible(child: Text(item.emoji, style: TextStyle(fontFamily: 'Poppins', fontSize: fontSize))),
          Text(item.name, style: TextStyle(fontFamily: 'Poppins', fontSize: 9, fontWeight: FontWeight.bold, color: Colors.white), textAlign: TextAlign.center),
          if (item.isMatched) Icon(Icons.check_circle, color: Colors.white, size: 16),
        ],
      ),
    );
  }
  ...
  Widget _buildEmptySlot(double size, bool isSmall, bool isVerySmallHeight) {
    return Container(
      ...
      child: Icon(Icons.check_circle, size: 22, color: Colors.green.shade300),
    );
  }
