          ...
          Dialog(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Icon(Icons.celebration, size: 56, color: Colors.white),
                  SizedBox(height: 12),
                  Text(
                    'Well done!',
                  ...
                  Text(
                    ...
                    style: TextStyle(fontFamily: 'Poppins', color: Colors.white, fontWeight: FontWeight.w500),
                  ...
                  Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        child: Text('Level Two', style: TextStyle(fontFamily: 'Poppins',  fontWeight: FontWeight.w600)),
                      ),
                      SizedBox(width: 12),
                      OutlinedButton(
                        onPressed: () {
                        ...
                        child: Text('Restart', style: TextStyle(fontFamily: 'Poppins',  color: Colors.white)),
                      ),
                    ],
                  ),
                ],
              ...
              Container(
                ...
                child: SingleChildScrollView(
                  child: Wrap(
                    ...
                    spacing: 12,
                    runSpacing: 12,
                    children: List.generate(correctAnswer, (index) => Text(currentItem, style: TextStyle(fontFamily: 'Poppins', fontSize: 40))),
                  ),
                ),
              ),
              SizedBox(height: 32),
              Text('How many?', style: TextStyle(fontFamily: 'Poppins', fontSize: 18, color: Colors.grey)),
              SizedBox(height: 16),
              Wrap(
                spacing: 16,
                runSpacing: 16,
