                    ...
                    children: [
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(currentItem, style: TextStyle(fontFamily: 'Poppins', fontSize: displayLeft)),
                        ),
                      ),
                      Text(
                        'VS',
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(currentItem, style: TextStyle(fontFamily: 'Poppins', fontSize: displayRight)),
                        ),
                      ),
                    ],
                  ),
