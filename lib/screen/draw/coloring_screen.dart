          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                child: Icon(Icons.arrow_back, color: Color(0xFFE17055)),
              ),
            ),
            SizedBox(width: 12),
            Column(
                    ...
                    child: ClipRRect(
                      ...
                      child: GestureDetector(
                        ...
                        onPanEnd: (details) {
                          setState(() {
                            points.add(
                              DrawingPoint(null, Colors.transparent, 0),
                            );
                          });
                        },
                        child: CustomPaint(
...
class DrawingPainter extends CustomPainter {
  ...
  void _drawTemplate(Canvas canvas, Size size, int template) {
    ...
    switch (template) {
      case 0:
        _drawButterfly(canvas, cx, cy, paint);
        break;
      case 1:
        _drawFlower(canvas, cx, cy, paint);
        break;
      case 2:
        _drawHouse(canvas, cx, cy, paint);
        break;
      case 3:
        _drawCar(canvas, cx, cy, paint);
        break;
      case 4:
        _drawStar(canvas, cx, cy, paint);
        break;
      case 5:
        _drawFish(canvas, cx, cy, paint);
        break;
      case 6:
        _drawSun(canvas, cx, cy, paint);
        break;
      case 7:
        _drawMoon(canvas, cx, cy, paint);
        break;
      case 8:
        _drawCloud(canvas, cx, cy, paint);
        break;
      case 9:
        _drawRainbow(canvas, cx, cy, paint);
        break;
      case 10:
        _drawBalloon(canvas, cx, cy, paint);
        break;
      case 11:
        _drawCake(canvas, cx, cy, paint);
        break;
      case 12:
        _drawApple(canvas, cx, cy, paint);
        break;
      case 13:
        _drawIceCream(canvas, cx, cy, paint);
        break;
      case 14:
        _drawGift(canvas, cx, cy, paint);
        break;
      case 15:
        _drawBall(canvas, cx, cy, paint);
        break;
      case 16:
        _drawRocket(canvas, cx, cy, paint);
        break;
      case 17:
        _drawAirplane(canvas, cx, cy, paint);
        break;
      case 18:
        _drawBoat(canvas, cx, cy, paint);
        break;
      case 19:
        _drawTrain(canvas, cx, cy, paint);
        break;
      case 20:
        _drawTent(canvas, cx, cy, paint);
        break;
      case 21:
        _drawCastle(canvas, cx, cy, paint);
        break;
      case 22:
        _drawTree(canvas, cx, cy, paint);
        break;
      case 23:
        _drawSunflower(canvas, cx, cy, paint);
        break;
      case 24:
        _drawBee(canvas, cx, cy, paint);
        break;
      case 25:
        _drawDuck(canvas, cx, cy, paint);
        break;
      case 26:
        _drawOctopus(canvas, cx, cy, paint);
        break;
      case 27:
        _drawTurtle(canvas, cx, cy, paint);
        break;
      case 28:
        _drawCrab(canvas, cx, cy, paint);
        break;
      case 29:
        _drawCat(canvas, cx, cy, paint);
        break;
      case 30:
        _drawDog(canvas, cx, cy, paint);
        break;
      case 31:
        _drawRabbit(canvas, cx, cy, paint);
        break;
      case 32:
        _drawMushroom(canvas, cx, cy, paint);
        break;
      case 33:
        _drawPalette(canvas, cx, cy, paint);
        break;
      case 34:
  ...
  void _drawButterfly(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 60, cy - 30), width: 80, height: 100),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 60, cy + 40), width: 70, height: 80),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx + 60, cy - 30), width: 80, height: 100),
    ...
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy), width: 20, height: 120),
      paint,
    );
  ...
  void _drawCar(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(cx - 80, cy - 20, 160, 50),
    ...
    canvas.drawRRect(
      RRect.fromRectAndRadius(
        Rect.fromLTWH(cx - 50, cy - 50, 100, 30),
        const Radius.circular(10),
      ),
      paint,
    );
  ...
  void _drawBalloon(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy - 30), width: 80, height: 100),
      paint,
    );
  ...
  void _drawCake(Canvas canvas, double cx, double cy, Paint paint) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      canvas.drawOval(
        Rect.fromCenter(center: Offset(x, cy - 48), width: 10, height: 15),
        paint,
      );
    }
    for (int i = 0; i < 4; i++) {
      canvas.drawLine(
        Offset(cx - 60 + (i * 30), cy + 15),
        Offset(cx - 45 + (i * 30), cy + 35),
        paint,
      );
    }
  }
  ...
  void _drawCastle(Canvas canvas, double cx, double cy, Paint paint) {
    ...
    for (int i = 0; i < 5; i++) {
      canvas.drawRect(
        Rect.fromLTWH(cx - 90 + (i * 45), cy - 70, 20, 10),
        paint,
      );
    }
  }
  ...
  void _drawSunflower(Canvas canvas, double cx, double cy, Paint paint) {
    for (int i = 0; i < 12; i++) {
      ...
      canvas.drawOval(
        Rect.fromCenter(center: Offset(x, y), width: 35, height: 50),
        paint,
      );
    }
  ...
  void _drawBee(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy), width: 80, height: 60),
      paint,
    );
    for (int i = 0; i < 3; i++) {
      canvas.drawLine(
        Offset(cx - 30 + (i * 20), cy - 30),
        Offset(cx - 30 + (i * 20), cy + 30),
        paint..strokeWidth = 6,
      );
    }
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 35, cy), width: 40, height: 35),
      paint,
    );
    final wingLeft = Path()
      ..moveTo(cx - 20, cy - 30)
  ...
  void _drawDuck(Canvas canvas, double cx, double cy, Paint paint) {
    ...
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx + 30, cy + 40), width: 40, height: 25),
      paint,
    );
  }
  ...
  void _drawTurtle(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy), width: 100, height: 70),
      paint,
    );
    canvas.drawCircle(Offset(cx - 60, cy - 10), 20, paint);
    canvas.drawCircle(Offset(cx - 10, cy - 10), 15, paint);
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 70, cy + 20), width: 30, height: 15),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 30, cy + 30), width: 25, height: 15),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx + 30, cy + 30), width: 25, height: 15),
  ...
  void _drawCrab(Canvas canvas, double cx, double cy, Paint paint) {
    ...
    for (int i = 0; i < 3; i++) {
      canvas.drawLine(
        Offset(cx - 35 + (i * 15), cy + 30),
        Offset(cx - 40 + (i * 15), cy + 50),
        paint,
      );
      canvas.drawLine(
        Offset(cx + 5 + (i * 15), cy + 30),
        Offset(cx + (i * 15), cy + 50),
        paint,
      );
    }
  }
  ...
  void _drawDog(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawCircle(Offset(cx, cy), 50, paint);
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 55, cy - 15), width: 30, height: 50),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx + 55, cy - 15), width: 30, height: 50),
    ...
    canvas.drawCircle(Offset(cx + 18, cy - 10), 8, paint);
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy + 15), width: 25, height: 20),
      paint,
    );
  ...
  void _drawRabbit(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawCircle(Offset(cx, cy), 50, paint);
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx - 25, cy - 60), width: 20, height: 70),
      paint,
    );
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx + 25, cy - 60), width: 20, height: 70),
  ...
  void _drawMushroom(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawArc(
      Rect.fromCenter(center: Offset(cx, cy - 20), width: 120, height: 100),
      math.pi,
      math.pi,
      false,
      paint,
  ...
  void _drawPalette(Canvas canvas, double cx, double cy, Paint paint) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(cx, cy), width: 120, height: 100),
      paint,
    );
    canvas.drawCircle(
      Offset(cx + 40, cy + 30),
