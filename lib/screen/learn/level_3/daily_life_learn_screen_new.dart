...
class _DailyLifeLearnScreenState extends State<DailyLifeLearnScreen> with SingleTickerProviderStateMixin {
  final FlutterTts flutterTts = FlutterTts();
  String? selectedItem;
  String selectedCategory = 'Weather'; // Default selected category
  late AnimationController _animationController;

  // Daily Life Categories with deeper colors
  final Map<String, List<Map<String, dynamic>>> dailyLifeCategories = {
    'Weather': [
      ...
      },
      {
        ...
        'description': 'Hold your hat!',
      },
      {
        'name': 'Stormy',
        'emoji': '⛈️',
        'icon': Icons.thunderstorm,
        'color': const Color(0xFF5B4EBF),
        'description': 'Stay inside safe!',
      },
    ],
    'Emotions': [
      {
